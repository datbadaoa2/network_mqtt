...
class ClientHandler implements Runnable
{
    ...
    // constructor
    public ClientHandler(Socket s, String name, DataInputStream dis, DataOutputStream dos, String type, String topic) {
        this.dis = dis;
        this.dos = dos;
        this.name = name;
        this.type = type;
...
//                    System.out.println(Server.ar);
                    for (ClientHandler mc : Server.ar) {
                        if (mc.type.equals("subscribe") && mc.topic.equals(topic_client) && mc.isloggedin==true)
                        {
